...
public class LPSO1 {
    ...
    public LPSO1(int[] tasklength, int[] outputfilesize, int[] mips, double[] execcost,
...
//		swarm.setParticleUpdate(new UpdationPSO(new ParticlePSO()));
        swarm.setParticleUpdate(new LpsoModifiedPSOUpdate(new ParticlePSO1())); //更新粒子 的速度和位置
...
//            System.out.println( swarm.getBestFitness());
        ...
        System.out.println("  LPSO The best fitness value is " + swarm.getBestFitness());
        System.out.println("\nLPSO Best makespan: " + ff.calcMakespan(swarm.getBestParticle().getBestPosition()));
