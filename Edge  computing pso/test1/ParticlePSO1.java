...
public class ParticlePSO1 extends Particle {
	/*
	 * Global Parameters: count : refers to the number of iterations that has been completed by a
	 * particle position[] : represents the position of the particle in n-dimension. velocity[] :
	 * represents the velocity of the particle in n-dimension.
	 */
	int count = 0;
