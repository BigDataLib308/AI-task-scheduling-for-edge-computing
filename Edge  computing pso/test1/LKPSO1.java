...
public class LKPSO1 {
    ...
    public LKPSO1(int[] tasklength, int[] outputfilesize, int[] mips, double[] execcost,
...
//		swarm.setParticleUpdate(new UpdationPSO(new ParticlePSO()));
        swarm.setParticleUpdate(new LKpsoModifiedPSOUpdate(new ParticlePSO1())); //更新粒子 的速度和位置
...
//            System.out.println( swarm.getBestFitness());
        ...
        System.out.println(" LKPSO The best fitness value is " + swarm.getBestFitness());
        System.out.println("\n  LKPSO  Best makespan: " + ff.calcMakespan(swarm.getBestParticle().getBestPosition()));
